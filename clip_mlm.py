...
class CLIP(nn.Module):
    def __init__(
        ...
        self.fc3 = nn.Linear(2 * dim_text, 2)
    ...
    def forward(
        ...
        if training_classifier:
            ...
            enc_text = enc_text.mean(dim=1)
            # # related information
            x1 = F.gelu(self.to_text_latent1(enc_text))
            x1 = F.gelu(self.to_text_latent2(x1))

            # classificaiton information
            x2 = F.gelu(self.fc1(enc_text))
        ...
        CLS1 = F.gelu(self.to_text_latent1(CLS1))
        CLS2 = F.gelu(self.to_text_latent1(CLS2))

        CLS1 = F.gelu(self.to_text_latent2(CLS1))
        CLS2 = F.gelu(self.to_text_latent2(CLS2))
